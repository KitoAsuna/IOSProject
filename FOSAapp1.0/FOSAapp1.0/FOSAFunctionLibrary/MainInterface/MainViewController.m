...
//<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,FOSAFlowLayoutDelegate,UICollectionViewDelegateFlowLayout>{
//    NSString *ID;
//    NSString *docPath;
//    //刷新标识
//    Boolean isUpdate;
