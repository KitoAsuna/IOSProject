...
@interface fosaWebViewController ()<WKNavigationDelegate,WKUIDelegate>
@property(nonatomic,strong) WKWebView *qrWebView;
@property (nonatomic,strong) UIProgressView *progressView;
@end

@implementation fosaWebViewController
...
- (void)creatWebView{
    ...
    self.qrWebView = [[WKWebView alloc]initWithFrame:CGRectMake(0, NavigationBarHeight, screen_width, screen_height-NavigationBarHeight) configuration:config];
